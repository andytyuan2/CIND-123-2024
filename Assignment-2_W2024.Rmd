...
#INSERT YOUR ANSWER HERE
library(dplyr)
countsurvive <- dplyr::count(titanicDataset['age' < 18 & 'survived' == 1])
survived <- sum(titanicDataset$survived[titanicDataset$age < 18], na.rm = T)
countsurvive
survived
```
...
# 1)
bindomrandom <- rbinom(50000, 3, 0.5)
bindomrandom
