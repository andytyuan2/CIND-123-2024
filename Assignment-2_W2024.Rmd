...
# the distribution of female fares is larger, so it looks like females tend to pay more for a ticket onto the boat
```
...
for (i in 1:number){
  if ((is.character(titanicDataset$home.dest[i]) & titanicDataset$age[i] >= 50 & titanicDataset$embarked[i] == "S" & titanicDataset$sex[i] == "female") == TRUE){
